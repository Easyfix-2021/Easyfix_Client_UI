...
const QR_LOGO =
  ...
  encodeURIComponent(
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">' +
      ...
      '<path d="M24 11 L39 24 h-4 v13 H13 V24 H9 Z" fill="#d9212b"/>' +
      '<rect x="21" y="28" width="6" height="9" fill="#ffffff"/>' +
    '</svg>',
  );
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[1.1fr_.9fr] gap-5 px-6 py-5">
          <div>
            ...
            <div className="mt-3">
              ...
              <div className="mt-1 flex items-start gap-2 border border-slate-200 rounded-xl bg-slate-50 p-2.5">
                <span className="flex-1 min-w-0 text-sm text-slate-700 break-all leading-snug pt-1.5">{qrValue}</span>
                <button type="button" onClick={copyLink}
                  className={`shrink-0 self-stretch px-3 rounded-lg border border-slate-200 bg-white text-sm font-bold inline-flex items-center gap-1.5 ${copied ? 'text-emerald-600' : 'text-primary'}`}>
